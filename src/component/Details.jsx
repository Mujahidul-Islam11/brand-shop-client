...
const Details = () => {
    ...
    return (
        ...
        <div className="grid md:grid-cols-4 gap-6 container  my-10">
            {
               filterProduct?.length> 0 ? filterProduct?.map(productDetail => <DetailsOfProduct productDetail={productDetail} key={productDetail._id}></DetailsOfProduct>):<div className="w-max mx-auto col-span-4"><h3 className="text-2xl">No data available</h3></div>
            }
        </div>
        </div>
    );
