...
const Navbar = () => {
  ...
  const links = (
    <ul className={`${darkMode ? "text-white" : "text-black"} md:flex`}>
  ...
  return (
    <div className={`navbar ${darkMode ? "bg-gray-900" : "bg-base-100"}`}>
      <div className="navbar-start">
        ...
        <div className="flex justify-center items-center gap-6">
          <NavLink className={"flex items-center"} to={"/"}>
            <img
              className="w-16"
              src="https://i.postimg.cc/vTj695nH/f-2-removebg-preview.png"
              alt=""
            />
            <h3
              className={`text-xl font-serif font-semibold mt-3 ${
                darkMode ? "text-white" : ""
              }`}
            >
              Movie Mall
        ...
        {user ? (
          <div className="lg:flex hidden flex-wrap items-center gap-4">
            ...
            <button
              onClick={handleLogOut}
              type="button"
              className="btn md:inline-block focus:ring-4 focus:outline-none font-bold rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 "
            >
              LogOut
            </button>
          </div>
